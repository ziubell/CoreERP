...
namespace CoreERP.Infrastructure.Migrations
{
    ...
    [Migration("20260320155918_AddPreferenzeSottoscrizione")]
    partial class AddPreferenzeSottoscrizione
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoreERP.Domain.Entities.Messaggi.AllegatoMessaggio", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AllegatiMessaggio", (string)null);
                });

            modelBuilder.Entity("CoreERP.Domain.Entities.Messaggi.Messaggio", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EntitaTipo", "EntitaId", "DataCreazione")
                        .IsDescending(false, false, true);

                    b.ToTable("Messaggi", (string)null);
                });
            ...
            modelBuilder.Entity("CoreERP.Domain.Entities.Notifications.SottoscrizioneNotifica", b =>
                {
                    ...
                    b.Property<bool>("NotificaContatti")
                        .HasColumnType("bit");

                    b.Property<bool>("NotificaIndirizzi")
                        .HasColumnType("bit");

                    b.Property<bool>("NotificaMessaggi")
                        .HasColumnType("bit");

                    b.Property<bool>("NotificaModifiche")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("CoreERP.Domain.Entities.Messaggi.AllegatoMessaggio", b =>
                {
                    b.HasOne("CoreERP.Domain.Entities.Messaggi.Messaggio", "Messaggio")
                        .WithMany("Allegati")
