...
{
    Task<List<Contatto>> GetListAsync(string? ricerca = null, int pagina = 1, int dimensionePagina = 20, int? excludeAnagraficaId = null);
    Task<int> CountAsync(string? ricerca = null, int? excludeAnagraficaId = null);
